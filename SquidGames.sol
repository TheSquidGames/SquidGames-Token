...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 1 * (10**17); // 0.1 AXS minimum auto send
...
contract SQUIDGAMES is
    BASEToken("International Squid Games", "SQUIDGAMES", 1000000000 * (10**9), 9),
    SafeToken,
    LockToken
{
    using SafeMath for uint256;
    ...
    constructor() {
        ...
        marketing = 0xba259D3dEb5d2F3CE27f399f12b4817077D9e2C6;
